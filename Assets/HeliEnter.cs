...
public class HeliEnter : MonoBehaviour
{
    ...
    public void EnterCar()
    {
        ...
        Debug.DrawLine(seatPosition, seatPosition+Vector3.up*1000, Color.red, 1000);
    ...
    //     carDestination.GetComponent<CarExit>().intheCar = true;
        ...
        enterCube.SetActive(true); //  disable the enter cube
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //if (other.GetComponent<XROrigin>().enabled)
